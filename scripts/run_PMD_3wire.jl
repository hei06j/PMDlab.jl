...
PMDlab.augment_math_3wire!(math3w; vsource_model_vm=true, Vsequence_bounds=true, cost_multiplier=1000)  # changing some of the input data


PMDlab.make_impedances_symmetric!(math3w)
